...
export default function About() {
  return (
    <main className="container mx-auto px-4 py-12 mt-8 space-y-16">
      <FadeInView>
          ...
          <div className="flex gap-4 flex-col">
            <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                The Photo Store was founded in 1987 by Myrle & Corlis. The
                company started as a small lab that mainly focuses on film
                processing and has grown to include a photo store and
                photography services.
              </p>
            </div>
            <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-2">
                Melissa takes over the photo store in 2013
              </h3>
              <p className="text-gray-600 dark:text-gray-300">
                In 2013 Melissa Frisk purchased the company. She brought new
                ideas and expanded the company&apos;s services to include
                digital photography. She has kept The Photo Store alive and
