    ...
    return (
        <main className="bg-white dark:bg-neutral-900">
            ...
            <ServiceSection
                ...
                services={[
                    { name: "Film Development", description: "Processing for 35mm, 120, and large format films, both color and black & white." },
            ...
            <ServiceSection
                ...
                services={[
                    ...
                    { name: "Photography Classes", description: "Workshops and classes for aspiring photographers." },
                    { name: "Equipment Rental", description: "Rent professional-grade cameras and lighting equipment." },
