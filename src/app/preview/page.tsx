...
const COMPONENTS = [
    [
        "Call to action",
        <CallToAction key="welcome-offer" title="Welcome Offer" buttonLink="#" buttonText="Claim Now"
    ...
    [
        "Location",
        <Location key="location" title="The Photo Store" address="3706 Olsen Blvd" city="Amarillo" state="Texas"
                  zipCode="79109"/>
    ],
    [
        "Log In",
    ...
    [
        "All Collections",
        <AllCollections key="all collections"/>
    ],
    [
        "Beta Warning",
        <BetaWarning isBeta={true} key="Beta Warning"/>
    ],
    [
        "Service Hero",
    ...
    [
        "Gallery Card",
        <GalleryCard key="GalleryCard" work={{
            title: "TITLE",
