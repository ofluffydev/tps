...
const Header = ({isBeta}: HeaderProps) => {
    ...
    return (<header className="dark:bg-neutral-950 bg-white dark:text-white text-black fixed w-full z-50">
        <nav className="container mx-auto px-4 py-3">
            <div className="flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center space-x-4">
                    ...
                    {isBeta ? <Link href="/preview" className="hover:text-gray-300">Preview</Link> : null}
                    <ThemeToggle/>
                </div>
                ...
                <div className="md:hidden flex items-center space-x-2">
                    ...
                    <button onClick={toggleMenu} className="text-black dark:text-white focus:outline-none">
                        <svg className="h-6 w-6 fill-current" viewBox="0 0 24 24"
                            ...
                            {isMenuOpen ? (<path fillRule="evenodd" clipRule="evenodd"
            ...
            >
                <div className="py-2 space-y-1">
                    ...
                    <Link href="/about"
                          className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-700 hover:text-white">About
                        Us</Link>
                    <Link href="/services"
                    ...
                    {isBeta ? <Link href="/preview"
                                    className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-700 hover:text-white">Preview</Link> : null}
                </div>
            </div>
        </nav>
    </header>);
