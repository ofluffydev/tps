...
const Hero = () => {
    return <div className="relative h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
            ...
            <FadeInView>
                <h1 className="mb-4 md:text-5xl text-lg font-bold text-center">Capture and Process Life&apos;s
                    Moments</h1>
            </FadeInView>
            <FadeInView>
                <p className="mb-8 md:text-xl text-center">Professional photography and top-notch lab services</p>
            </FadeInView>
